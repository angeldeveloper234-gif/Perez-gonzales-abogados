        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-24">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 font-sans text-sm text-gray-500">
              ...
              <p className="max-w-[200px] leading-relaxed italic">{CONTACT_INFO.locations[0].address}</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-6">
              <a
                href="https://web.facebook.com/people/P%C3%A9rez-y-Gonz%C3%A1lez-abogados/61559029127246/"
                target="_blank"
